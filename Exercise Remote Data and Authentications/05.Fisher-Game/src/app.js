function app() {
    ...
    async function onUpdate(e) {
        ...
        const data = {
            angler: anglerRef.value.trim(),
            weight: weightRef.value.trim(),
            species: speciesRef.value.trim(),
            location: locationRef.value.trim(),
            bait: baitRef.value.trim(),
            captureTime: captureTimeRef.value.trim()
        }
